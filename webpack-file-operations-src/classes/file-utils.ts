...
import { ConsoleLogger } from '@wecdev/webpack-hook-attacher';
...
export class FileUtils {
    ...
    public static getSplittedFile(sourceFromGlob: string, encoding: BufferEncoding): SplittedFile {
    ...
    public static insertTextToSingleFile(singleSource: string, encoding: BufferEncoding, text: string, rowIndex: number): void {
    ...
    public static removeRowsFromSingleFile(sourceFilePath: string, encoding: BufferEncoding, rowIndexAndRemoveCountList: IndexAndCount[]): void {
    ...
    public static replaceInSingleFile(sourceFilePath: string, encoding: BufferEncoding, replaceRules: ReplaceRule[]): void {
